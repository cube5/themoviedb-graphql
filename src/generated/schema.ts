...
export interface Query {
    ...
    search: <T = Search | null>(args?: {}, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> ,
    movie: <T = Movie | null>(args: { id: ID_Output }, info?: GraphQLResolveInfo | string, options?: Options) => Promise<T> 
  }
